...
(function($, window, document, undefined) {
    $.fn.socialfeed = function(_options) {
        ...
        var defaults = {
            ...
            template: '/social/template.html', // a path to the template file
                        ...
                        if (element.id) {
                            ...
                            if (options.show_media === true) {
                                if (element.entities.media && element.entities.media.length > 0) {
                                    ...
                                    if (image_url) {
                                        post.attachment = '<img class="attachment" width="100%" height="100%" src="' + image_url + '" />';
                                    }
                                }
                            }
                        }
            ...
            facebook: {
                ...
                utility: {
                    ...
                    prepareAttachment: function(element) {
                        ...
                        return '<img class="attachment" width="100%" height="100%" src="' + image_url + '" />';
                    },
                        ...
                        if (options.show_media === true) {
                            if (element.object.attachments) {
                                $.each(element.object.attachments, function() {
                                    ...
                                    post.attachment = '<img class="attachment" width="100%" height="100%" src="' + image + '"/>';
                                });
                            }
                        }
                ...
                utility: {
                    ...
                    unifyPostData: function(element) {
                        ...
                        if (options.show_media) {
                            post.attachment = '<img class="attachment" width="100%" height="100%" src="' + element.images.standard_resolution.url + '' + '" />';
                        }
                        return post;
                    }
                }
            ...
            pinterest: {
                ...
                utility: {
                    ...
                    unifyPostData: function(element){
                        ...
                        if (options.show_media) {
                            post.attachment = '<img class="attachment" width="100%" height="100%" src="' + element.image['original'].url + '" />';
                        }
                        return post;
                    }
                }
                ...
                utility: {
                    ...
                    unifyPostData: function(index, element){
                        ...
                        if (options.show_media && item.thumbnail !== undefined ) {
							...
							post.attachment = '<img width="100%" height="100%" class="attachment" src="https://www.icslearn.co.uk/images/logo.png" />';
                        }
                        return post;
                    }
                }
